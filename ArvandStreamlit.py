...
def main():
    ...
    filial = st.selectbox("Какой филиал вас интересует:", ["Ч. Расулов", "Хучанд", 'Истаравшан' , 'Исфара', "Душанбе", "Панчакент"])
    ...
    nationality = st.selectbox("Национальность:", ['Другие', "Точик","Рус", "Узбек", "Тотор", "Киргиз", "Украин", "Карис", "Карачои"])
    ...
    nat_code = 0 
    if(nationality == "Точик"):
        nat_code = 1 
    elif(nationality == 'Узбек'):
        nat_code = 2
    elif(nationality == 'Тотор'):
        nat_code = 3
    elif(nationality == 'Рус'):
        nat_code = 4
    elif(nationality == 'Киргиз'):
        nat_code = 5
    elif(nationality == 'Украин'):
        nat_code = 6
    elif(nationality == 'Карис'):
        nat_code = 7
    elif(nationality == 'Карачои'):
        nat_code = 8
    else:
        nat_code = 0
    ...
    if st.button("Predict"):
        result=int(predict_note_authentication(fam_size, busexp, number, time, timeofcredit, income, gen_code, fam_code, edu_code, filial_code, cus_code, bus_code, nat_code, age, zalog_code))
